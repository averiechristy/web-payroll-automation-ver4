            ...
            <div class="col-md-12 grid-margin">
                ...
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Gaji dan Cadangan Transfer Knowledge Tester Manual</h3>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="py-3">
                        ...
                        <a href="{{ route('downloadgajitm') }}" id="download-template-link">
                                <button type="button" class="btn btn-warning" download>Unduh Template</button>
                            </a>
                        </div>
                        <div class="importdata ml-3">

                        <form id="upload-form" action="{{ route('importgajitm') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                        @csrf
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                <thead>
                                   ...
                                   <th>Periode</th>
                                   <th>Gaji</th>
                                   <th>Cadangan Transfer Knowledge</th>
                                   <th>Created By</th>
                                   <th>Created At</th>
                                   <th>Action</th>
                                    </tr>
...
@endphp
                                ...
                                @foreach ($gajitm as $item )
                                <tr>
                                    <td>{{$item->karyawan->nama_karyawan}}</td>
                                    <td>{{$bulanIndo[$item->bulan]}} {{$item->tahun}}</td>
                                    <td>{{ 'Rp ' . number_format($item->gaji_tm, 0, ',', '.') }}</td>
                                    <td>{{ 'Rp ' . number_format($item->cadangan_tfknowledge, 0, ',', '.') }}</td>
                                    <td>{{$item->created_by}}</td>
                                    <td>{{$item->created_at}}</td>
                                    <td>
                                    <form id="deleteForm-{{ $item->id }}" method="POST" action="{{ route('deletegajitm', $item->id) }}">
                                                @csrf
