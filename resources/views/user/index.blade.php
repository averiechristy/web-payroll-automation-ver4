                ...
                <div class="card shadow mb-4">
                    <div class="py-3">
                        <a href="{{route('user.create')}}">
                            <button type="button" class="btn btn-primary ml-3">Tambah User</button>
                        </a>
                    </div>
                    <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form id="deleteForm" method="POST" action="{{ route('deleteuser', $item->id) }}">
                                                    @csrf
                                                ...
                                                <form action="{{ route('reset-password', ['user' => $item->id]) }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn btn-rounded btn-icon" data-toggle="tooltip" title="Reset Password">
                                                        <i class="ti-reload text-info" style="font-weight: bold;"></i>
                                                    </button>
                                                </form>
