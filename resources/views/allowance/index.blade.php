            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class ="font-weight-bold">Uang Saku & Insentif</h3>
                </div>
              </div>
              <div class="card shadow mb-4">
                <div class=" py-3">
                    <a href="{{route('allowance.create')}}">
                    <button type="button" class="btn btn-primary ml-3">Tambah Uang Saku & Insentif</button>
                </a>
                </div>
            <div class="card-body">
...
<div id="myDataTable_filter" class="dataTables_filter">
    <label for="search">search
        <input id="search" placeholder>
                    ...
                    <tr>
                    <td>Uang saku & insentif {{ DateTime::createFromFormat('!m', $item->bulan)->format('F') }} {{$item->tahun}}</td>

                 <td>
                 <a href="{{route('detailallowance', $item->id)}}">
                 Lihat Detail               
                 </a>
                 </td>
                 ...
                 <td>
                                    <a href="{{route('showallowance', $item->id)}}">
