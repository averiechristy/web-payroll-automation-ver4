...
<div id="myDataTable_filter" class="dataTables_filter">
  ...
  <tr>
    <th rowspan="2">NIK</th>
    <th rowspan="2">Payroll Code</th>
    <th rowspan="2">Nama Karyawan</th>
    <th rowspan="2">Tanggal Lembur</th>
    <th rowspan="2">Jenis Hari</th>
    ...
    <th colspan="8">Perhitungan Lembur</th>
    <th rowspan="2">Sub Total</th>
    <th rowspan="2">Management Fee</th>
    <th rowspan="2">Total sebelum PPN</th>
    <th rowspan="2">Keterangan</th>
    <th rowspan="2">Action</th>
  </tr>
  <tr>
    <td colspan="2">Jam 1</td>
    <td colspan="2">Jam 2</td>
    <td colspan="2">Jam 3</td>
    <td colspan="2">Jam 4</td>
...
<tr>
    ...
    <td>{{$item -> karyawan -> payroll_code}}</td>
