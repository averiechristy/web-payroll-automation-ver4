        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
              ...
              <div class="card shadow mb-4">
                  ...
                  <div class="row mb-4">
      <div class="col-md-12">
          <a href="{{ route('download.mad', ['bulan' => $mad->bulan, 'tahun' => $mad->tahun]) }}" class="btn btn-success">Download MAD</a>
      </div>
  </div>
...
<div id="myDataTable_filter" class="dataTables_filter">
   ...
   <tr>
    ...
    <td>{{$item->karyawan->kode_cabang_pembayaran}}</td>
    <td>{{$item->karyawan->rcc_pembayaran}}</td>
