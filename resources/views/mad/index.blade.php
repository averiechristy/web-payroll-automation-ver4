...
<div id="myDataTable_filter" class="dataTables_filter">
  ...
  <tr>
   ...
   <th>Cek Tanggal</th>
   <th>L/K</th>
   <th>Upah Pokok 2024</th>
   <th>Tunjangan Supervisor 2024</th>
   <th>Jam Mulai</th>
   <th>Jam Selesai</th>
...
<tr>
   ...
   <td>{{ 'Rp ' . number_format($item ->karyawan->upah_pokok, 0, ',', '.') }}</td>
   <td>{{ 'Rp ' . number_format($item ->karyawan->tunjangan_spv, 0, ',', '.') }}</td>
