            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Tambah MAD</h3>
                </div>
              </div>

            <div class="card shadow mb-4">
            <div class="card-body">
            <form name="saveform" action="{{route('mad.store')}}" method="post" onsubmit="return validateForm()">
              @csrf
...
<div class="form-group mb-4">
                    ...
                    <input name="tanggal_lembur" id="tanggal_lembur" type="date"  class="form-control " style="border-color: #01004C; width:30%;" value="" />
                    </div>
...
<div class="row">
  <div class="col">
    ...
    <div class="form-group mb-4">
      ...
      <input name="jam_mulai" id="jam_mulai" type="text" class="form-control" style="border-color: #01004C;" />
    </div>
  ...
  <div class="col">
    ...
    <div class="form-group mb-4">
      ...
      <input name="jam_selesai" id="jam_selesai" type="text" class="form-control" style="border-color: #01004C;" />
    </div>
...
<script>
  ...
  <div class="form-group mb-4">
                    ...
                    <input name="keterangan_lembur" type="text"  class="form-control " style="border-color: #01004C;" value="" />
                    </div>
  ...
  <div class="form-group mb-4">
                    ...
                    <input name="keterangan_perbaikan" type="text"  class="form-control " style="border-color: #01004C;" value="" />
                    </div>
