            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Posisi</h3>
                    </div>
                </div>

                <div class="card shadow mb-4">
                    <div class="py-3">
                        <h5 class="description ml-3">Unggah file untuk menambahkan data posisi baru, atau tambahkan ke kumpulan data posisi yang sudah ada. <br> Anda dapat mengunggah file Excel</h5>
                        <div class="button-group ml-3">
                            <a href="{{route('posisi.create')}}">
                                <button type="button" class="btn btn-primary">Tambah Posisi</button>
                            </a>
                            <a href="{{ route('downloadposisi') }}" id="download-template-link">
                                <button type="button" class="btn btn-warning" download>Unduh Template</button>
                            </a>
                        </div>
                        <div class="importdata ml-3">
                            <form id="upload-form" action="{{ route('importposisi') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                @csrf
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$item -> posisi}}</td>
                                        <td>{{$item -> standarisasi_upah}}</td>
                                        <td>{{$item->created_at}}</td>
                                        <td>{{$item->created_by}}</td>
                                        <td>{{$item->updated_at}}</td>
                                        <td>{{$item->updated_by}}</td>
                                        <td>
                                            <a href="{{route('showposisi', $item->id)}}">
                                            ...
                                            <form id="deleteForm-{{ $item->id }}" method="POST" action="{{ route('deleteposisi', $item->id) }}">
                                                @csrf
