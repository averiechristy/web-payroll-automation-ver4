                ...
                <div class="card shadow mb-4">
                    <div class="py-3">
                        <div class="button-group ml-3">
                            <a href="{{ route('downloadattendance') }}" id="download-template-link">
                                <button type="button" class="btn btn-warning" download>Unduh Template</button>
                            </a>
                        </div>
                        
                        <div class="importdata ml-3">
                            <form id="upload-form" action="{{ route('importattendance') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                @csrf
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                       ...
                                       <th>Check In</th>
                                       <th>Check Out</th>
                                       <th>Overtime Check In</th>
                                       <th>Overtime Check Out</th>
                                       <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                   ...
                                   <tr></tr>
                                    ...
                                    <td>{{$item->overtime_checkin}}</td> 
                                    <td>{{$item->overtime_checkout}}</td> 
                                    <td>
                                    <a href="{{route('showattendance', $item->id)}}">
