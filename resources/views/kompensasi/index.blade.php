            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class ="font-weight-bold">Kompensasi</h3>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="py-3 ml-3">
                        <h5 class ="font-weight-bold">Proses Kompensasi</h5>
                        <form name="saveform" action="{{route('kompensasi.store')}}" method="post" onsubmit="return validateForm()">
                        @csrf
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <p>Bulan</p>
                            ...
                            <table class="table">
                             ...
                             <tr>
                               ...
                               <tr>
                                <td>{{$item -> judul}}</td>
                                <td>    
                                <a href="{{route('tampilkompensasi', $item->id)}}">
                                        Lihat Detail               
                                </a>
                                </td>  
                                ...
                                <td>
    @if ($item->status_kompensasi == "Closing")
    <form action="{{ route('batalkan.closing.kompensasi', $item->id) }}" method="POST">
        @csrf
