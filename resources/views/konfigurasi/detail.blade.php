            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class ="font-weight-bold">Detail Penempatan</h3>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered">
                               ...
                               <thead>
                                    <th>Penempatan</th>
                                    <th>Hitung Tunjangan</th>
                                    <th>Perhitungan Payroll</th>
                                    <th>Buat Invoice</th>
                               </thead>
                               ...
                               <tbody>
                                ...
                                <td>{{$item -> hitung_tunjangan}}</td>
                        <td>
                        @if ($item->perhitungan_payroll == 'harikerja')
                           
Hari Kerja
                            @elseif ($item->perhitungan_payroll == 'kalender')
Kalender
                          
                            @endif
                        </td>
                        <td>{{$item->buat_invoice}}</td>
                                </tr>
                                @endforeach
