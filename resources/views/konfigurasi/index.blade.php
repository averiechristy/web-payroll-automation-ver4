            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Konfigurasi</h3>
                </div>            
              </div>

              <div class="card shadow mb-4">
              <div class="py-3">
    <a href="{{ route('konfigurasi.create') }}">
        <button type="button" class="btn btn-primary ml-3">Tambah Konfigurasi</button>
    </a>
</div>
                    ...
                    @include('components.alert')
                      ...
                      <tbody>
                       ...
                       <tr>
                        ...
                        <td>
                        <a href="{{route('detailkonfigurasi', $item->id)}}">
                                        Lihat Detail               
                                </a>
                        </td>
                        ...
                        <td>
                        <a href="{{route('showkonfigurasi', $item->id)}}">
