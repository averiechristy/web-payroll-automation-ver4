            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class ="font-weight-bold">Laporan Payroll</h3>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="py-3 ml-3">
                        <h5 class ="font-weight-bold">Proses Laporan Payroll</h5>
                        <form name="saveform" action="{{route('payroll.store')}}" method="post" onsubmit="return validateForm()">
                        @csrf
                            <div class="row mb-3">
                            <div class="col-md-3">
                                    <p>Organisasi</p>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                             ...
                             <tr>
                               ...
                               <tr>
                                <td>{{$item->judul_payroll}}</td>
                                <td>    
                                <a href="{{route('tampilpayroll', $item->id)}}">
                                        Lihat Detail               
                                </a>
                                </td>
                                <td>{{$item->status_payroll}}</td>  
                                <td>{{$item->created_by}}</td>
                                <td>{{$item->created_at}}</td>
                                <td>
    @if ($item->status_payroll == "Closing")
    <form action="{{ route('batalkan.closing.payroll', $item->id) }}" method="POST">
        @csrf
