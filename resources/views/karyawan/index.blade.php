              ...
              <div class="card shadow mb-4">
                ...
                <div class=" py-3">
                    ...
                    <div class="button-group ml-3">
                        ...
                        <a href="{{route('downloadkaryawan')}}">
                            <button type="button" class="btn btn-warning" download>Unduh Template</button>
                        </a>
                    </div>
                
                    <div class="importdata ml-3">
                        <form action="{{ route('importkaryawan') }}"  method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                        @csrf
        ...
        <input id="search" placeholder>
                    ...
                    @include('components.alert')
                      ...
                      <tr>
                        ...
                        <td>{{ $item -> jabatan }}</td>
                        <td>{{ $item -> upah_pokok }}</td>
                        <td>{{ $item -> tunjangan_spv}}</td>
