            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class="font-weight-bold">Overtime</h3>
                    </div>
                </div>
                ...
                <div class="card shadow mb-4">
                    <div class="py-3">
                        <div class="button-group ml-3">
                            ...
                            <a href="{{ route('downloadovertime') }}" id="download-template-link">
                                <button type="button" class="btn btn-warning" download>Unduh Template</button>
                            </a>
                        </div>
                        <div class="importdata ml-3">
                            <form id="upload-form" action="{{ route('importovertime') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                @csrf
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <td>{{$item->overtime_payment}}</td>
                                  <td>{{$item->overtime_multiplier}}</td>
                                  <td>{{$item->overtime_rate}}</td>
                                <td>
                                <a href="{{route('showovertime', $item->id)}}">
