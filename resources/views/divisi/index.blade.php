            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class ="font-weight-bold">Divisi</h3>
                </div>
              </div>
              <div class="card shadow mb-4">
                ...
                <div class="py-3">
                        <h5 class="description ml-3">Unggah file untuk menambahkan data divisi baru, atau tambahkan ke kumpulan data divisi yang sudah ada. <br> Anda dapat mengunggah file Excel</h5>
                        <div class="button-group ml-3">
                            <a href="{{route('divisi.create')}}">
                            <button type="button" class="btn btn-primary ml-3">Tambah Divisi</button>
                            </a>
                            <a href="{{ route('downloaddivisi') }}" id="download-template-link">
                                <button type="button" class="btn btn-warning" download>Unduh Template</button>
                            </a>
                        </div>
                        <div class="importdata ml-3">
                            <form id="upload-form" action="{{ route('importdivisi') }}" method="post" enctype="multipart/form-data" style="display: flex; align-items: center;">
                                @csrf
...
<div id="myDataTable_filter" class="dataTables_filter">
    <label for="search">search
        <input id="search" placeholder>
                    ...
                    <td>
                            <a href="{{route('showdivisi', $item->id)}}">
                            <button type="button" class="btn btn-rounded btn-icon" data-toggle="tooltip" title="Ubah">
                              ...
                              <form id="deleteForm" method="POST" action="{{ route('deletedivisi', $item->id) }}">
    @csrf
    <input name="_method" type="hidden" value="DELETE">
    <button type="button" class="btn btn-rounded btn-icon" data-toggle="modal" data-target="#confirmModal" title="Hapus">
