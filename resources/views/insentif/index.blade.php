            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class ="font-weight-bold">Insenitf</h3>
                </div>
              </div>
              <div class="card shadow mb-4">
                <div class=" py-3">
                    <a href="{{route('insentif.create')}}">
                    <button type="button" class="btn btn-primary ml-3">Tambah Insentif</button>
                </a>
                </div>
            <div class="card-body">
...
<td>{{ 'Rp ' . number_format($item->insentif, 0, ',', '.') }}</td>
<td>{{$item->created_by}}</td>
<td>{{$item->created_at}}</td>
<td>{{$item->updated_by}}</td>
<td>{{$item->updated_at}}</td>
<td>
                                            <a href="{{ route('showinsentif', $item->id) }}">
                                            ...
                                            <form id="deleteForm" method="POST" action="{{ route('deleteinsentif', $item->id) }}">
    @csrf
