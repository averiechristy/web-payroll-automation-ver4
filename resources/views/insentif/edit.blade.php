...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Edit Insentif</h3>
                </div>
            ...
            <div class="card-body">
            <form name="saveform" action="{{route('updateinsentif', $data->id)}}" method="post" onsubmit="return validateForm()">
                                        @csrf                
...
<div class="form-group mb-4">
    <label for="insentif" class="form-label" style="color:black;">Insentif</label>
    <input type="number" name="insentif" id="insentif" class="form-control" style="color:black;" value="{{ old('insentif', $data->insentif) }}" oninput="validasiNumber(this)">
</div>
