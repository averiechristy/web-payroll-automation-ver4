            ...
            <div class="col-md-12 grid-margin">
                <div class="row">
                    <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                        <h3 class ="font-weight-bold">Invoice Tester Manual</h3>
                    </div>
                </div>
                <!-- Card Buat Kompensasi -->
                <div class="card shadow mb-4">
                <div class="py-3 ml-3">
                        <h5 class ="font-weight-bold">Proses Invoice Tester Manual</h5>
                        <form name="saveform" action="{{route('testermanual.store')}}" method="post" onsubmit="return validateForm()">
                        @csrf
                            <div class="row mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($testermanual as $item )
                                    <tr>
                                        <td>{{$item -> judul_invoicetm}}</td>
                                        <td>    
                                <a href="{{route('tampiltestermanual', $item->id)}}">
                                        Lihat Detail               
                                </a>
                                </td>  
                                        <td>{{$item->status_invoicetm}}</td>
                                        <td>{{$item->created_by}}</td>
                                        <td>{{$item->created_at}}</td>
                                        <td>
    @if ($item->status_invoicetm == "Closing")
    <form action="{{ route('batalkan.closing.invoicetm', $item->id) }}" method="POST">
        @csrf
