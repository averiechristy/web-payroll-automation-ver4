...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                  <h3 class="font-weight-bold">Tambah Uang Saku</h3>
                </div>
            ...
            <div class="card-body">
            <form name="saveform" action="{{route('uangsaku.store')}}" method="post" onsubmit="return validateForm()">
                                        @csrf                
...
<div class="form-group mb-4">
                              ...
                              <input type="number" name="uang_saku" id="uang_saku" class="form-control" style="color:black;" oninput="validasiNumber(this)">
                            </div>
